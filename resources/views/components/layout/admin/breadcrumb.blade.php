            ...
            @foreach($items as $item)
                <li>
                    <div class="flex items-center">
                        ...
                        @if(!empty($item['url']))
                            <a href="{{ $item['url'] }}" class="text-sm font-medium text-slate-500 hover:text-slate-900 transition-colors font-satoshi-medium">
                                {{ $item['label'] }}
                            </a>
                        @else
                            <span class="text-sm font-medium text-slate-800 font-satoshi-bold">
                                {{ $item['label'] }}
                            </span>
                        @endif
                    </div>
